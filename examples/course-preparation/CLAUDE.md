...
Worked examples: the concentration operation runs on [inputs/fields-of-concentration/primary/linguistics.md](inputs/fields-of-concentration/primary/linguistics.md) → [outputs/linguistics-concentration-recommendations.md](outputs/linguistics-concentration-recommendations.md); the syllabus skill runs on [inputs/syllabus/cs20-syllabus.md](inputs/syllabus/cs20-syllabus.md) → [outputs/cs20-syllabus-redesign.md](outputs/cs20-syllabus-redesign.md), calibrated to match [outputs/gened1074-syllabus-redesign.md](outputs/gened1074-syllabus-redesign.md) — the canonical example the skill reads for structure, table, altitude, and voice (**keep it**). A second worked syllabus, [outputs/french40-syllabus-redesign.pdf](outputs/french40-syllabus-redesign.pdf), is a real participant course (FREN 40) shared with the instructor's permission. The syllabus skill is the canonical "improve your draft before class" move.
